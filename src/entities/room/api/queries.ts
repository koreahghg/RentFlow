...
import { getRoomDisplayStatus } from "../model/lib";
import type { Room, RoomDisplayStatus } from "../model/types";
import { getContractDisplayStatus, type Contract } from "@/entities/contract";
